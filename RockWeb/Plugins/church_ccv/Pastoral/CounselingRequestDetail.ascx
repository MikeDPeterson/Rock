<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.Pastoral.CounselingRequestDetail" Codebehind="CounselingRequestDetail.ascx.cs" %>
