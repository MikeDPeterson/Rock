<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.Pastoral.CounselingRequestList" Codebehind="CounselingRequestList.ascx.cs" %>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="">
            <div class="panel panel-block">
                <div class="panel-heading">
                    <h1 class="panel-title"><i class="fa fa-paste"></i> Counseling Requests</h1>
                </div>
                    ...
                    <div class="grid grid-panel">
                        ...
                        <Rock:Grid ID="gList" runat="server" DisplayType="Full" AllowSorting="true" OnRowDataBound="gList_RowDataBound" OnRowSelected="gList_Edit">
                            <Columns>
                                ...
                                <Rock:PersonField DataField="WorkerPersonAlias.Person" SortExpression="WorkerPersonAlias.Person.LastName, WorkerPersonAlias.Person.NickName" HeaderText="Worker" ColumnPriority="Tablet" />
