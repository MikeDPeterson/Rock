<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.SampleProject.ReferralAgencyDetail" Codebehind="ReferralAgencyDetail.ascx.cs" %>
