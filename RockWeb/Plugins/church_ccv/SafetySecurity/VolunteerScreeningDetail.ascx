<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.SafetySecurity.VolunteerScreeningDetail" Codebehind="VolunteerScreeningDetail.ascx.cs" %>
