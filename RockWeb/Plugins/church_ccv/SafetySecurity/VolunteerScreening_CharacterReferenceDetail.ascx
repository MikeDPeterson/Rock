<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.SafetySecurity.VolunteerScreening_CharacterReferenceDetail" Codebehind="VolunteerScreening_CharacterReferenceDetail.ascx.cs" %>
