<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.SafetySecurity.VolunteerScreening_CharacterReferenceList" Codebehind="VolunteerScreening_CharacterReferenceList.ascx.cs" %>
