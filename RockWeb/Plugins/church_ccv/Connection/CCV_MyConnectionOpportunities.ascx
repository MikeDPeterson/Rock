<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.Connection.CCV_MyConnectionOpportunities" Codebehind="CCV_MyConnectionOpportunities.ascx.cs" %>
