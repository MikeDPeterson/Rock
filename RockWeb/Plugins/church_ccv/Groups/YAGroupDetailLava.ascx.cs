...
namespace RockWeb.Plugins.church_ccv.Groups
{
    ...
    /// </summary>
    [DisplayName( "YA Group Detail Lava" )]
    [Category( "CCV > Groups" )]
    [Description( "Presents the details of a YA group using Lava" )]
    public partial class YAGroupDetailLava : ToolboxGroupDetailLava
    {
        ...
        const int YA_GroupRole_Attendee = 142;
        ...
        protected void btnSaveGroupMember_Click( object sender, EventArgs e )
        {
            if( Page.IsValid && ppGroupMemberPerson.SelectedValue.HasValue )
            {
                ...
                bool result = AddGroupMember( ppGroupMemberPerson.SelectedValue.Value, _groupId, YA_GroupRole_Attendee, selectedStatus.Value );
