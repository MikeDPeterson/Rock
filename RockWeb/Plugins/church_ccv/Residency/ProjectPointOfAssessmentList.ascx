<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.Residency.ProjectPointOfAssessmentList" Codebehind="ProjectPointOfAssessmentList.ascx.cs" %>
