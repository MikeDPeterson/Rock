<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.Residency.CompetencyPersonProjectDetail" Codebehind="CompetencyPersonProjectDetail.ascx.cs" %>
