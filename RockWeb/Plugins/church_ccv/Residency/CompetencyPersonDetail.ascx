<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.Residency.CompetencyPersonDetail" Codebehind="CompetencyPersonDetail.ascx.cs" %>
            ...
            <div class="panel-body">
                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <asp:Panel ID="pnlCompetencyDropDownLists" runat="server">
                        <Rock:DataDropDownList ID="ddlPeriod" runat="server" DataTextField="Name" DataValueField="Id" SourceTypeName="church.ccv.Residency.Model.Period, church.ccv.Residency" PropertyName="Name" AutoPostBack="true" OnSelectedIndexChanged="ddlPeriod_SelectedIndexChanged" Label="Period" />
                        <Rock:DataDropDownList ID="ddlTrack" runat="server" DataTextField="Name" DataValueField="Id" SourceTypeName="church.ccv.Residency.Model.Track, church.ccv.Residency" PropertyName="Name" AutoPostBack="true" OnSelectedIndexChanged="ddlTrack_SelectedIndexChanged" Label="Track" />
                        <Rock:DataDropDownList ID="ddlCompetency" runat="server" DataTextField="Name" DataValueField="Id" SourceTypeName="church.ccv.Residency.Model.Competency, church.ccv.Residency" PropertyName="Name" Label="Competency" CssClass="input-xlarge" />
