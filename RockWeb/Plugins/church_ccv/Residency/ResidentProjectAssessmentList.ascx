<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.Residency.ResidentProjectAssessmentList" Codebehind="ResidentProjectAssessmentList.ascx.cs" %>
