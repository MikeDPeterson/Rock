<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.Residency.CompetencyPersonProjectAssessmentDetail" Codebehind="CompetencyPersonProjectAssessmentDetail.ascx.cs" %>
