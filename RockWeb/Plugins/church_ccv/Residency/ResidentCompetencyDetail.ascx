<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.Residency.ResidentCompetencyDetail" Codebehind="ResidentCompetencyDetail.ascx.cs" %>
