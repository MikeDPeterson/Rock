<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.Residency.ResidentProjectAssessmentDetail" Codebehind="ResidentProjectAssessmentDetail.ascx.cs" %>
