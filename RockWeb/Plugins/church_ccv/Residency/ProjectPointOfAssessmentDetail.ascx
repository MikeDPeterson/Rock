<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Plugins.church_ccv.Residency.ProjectPointOfAssessmentDetail" Codebehind="ProjectPointOfAssessmentDetail.ascx.cs" %>
