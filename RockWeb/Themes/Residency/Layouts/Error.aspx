...
<head runat="server">
    ...
    <link rel="stylesheet" href="<%= Page.ResolveUrl("~/Themes/Residency/Styles/bootstrap.css") %>" />
    <link rel="stylesheet" href="<%= Page.ResolveUrl("~/Themes/Residency/Styles/theme.css") %>" />
