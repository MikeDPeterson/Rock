<%@ Page Language="C#" AutoEventWireup="true" Inherits="RockWeb.Themes.com_ccvstars_External_v5.Layouts.Error" Codebehind="Error.aspx.cs" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="<%= Page.ResolveUrl("~/Themes/com_ccvstars_External_v5/Styles/bootstrap.css") %>" />
    <link rel="stylesheet" href="<%= Page.ResolveUrl("~/Themes/com_ccvstars_External_v5/Styles/theme.css") %>" />
