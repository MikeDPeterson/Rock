<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Blocks.Communication.CommunicationRecipientList" Codebehind="CommunicationRecipientList.ascx.cs" %>
