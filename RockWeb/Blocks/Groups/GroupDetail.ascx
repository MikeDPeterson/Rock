<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Blocks.Groups.GroupDetail" Codebehind="GroupDetail.ascx.cs" %>
                ...
                <div class="panel-body">
                    ...
                    <div id="pnlEditDetails" runat="server">
                        ...
                        <Rock:PanelWidget ID="wpGroupAttributes" runat="server" Title="Group Attribute Values">
                            <asp:PlaceHolder ID="phGroupAttributes" runat="server" EnableViewState="false" />
                        </Rock:PanelWidget>
