<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Blocks.Cms.ThemeList" Codebehind="ThemeList.ascx.cs" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <Rock:ModalDialog ID="mdThemeClone" runat="server" Title="Clone Theme" ValidationGroup="vgClone" SaveButtonText="Clone" OnSaveClick="mdThemeClone_SaveClick" OnCancelScript="clearActiveDialog();">
                <Content>
                    <global:asp:ValidationSummary ID="valSummaryTop" runat="server" HeaderText="Please Enter A New Theme Name" CssClass="alert alert-danger" />
