<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Blocks.Event.EventCalendarItemPersonalizedRegistration" Codebehind="EventCalendarItemPersonalizedRegistration.ascx.cs" %>
