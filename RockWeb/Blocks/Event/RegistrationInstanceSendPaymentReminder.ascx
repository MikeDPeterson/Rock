<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Blocks.Event.RegistrationInstanceSendPaymentReminder" Codebehind="RegistrationInstanceSendPaymentReminder.ascx.cs" %>
