<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Blocks.Event.EventItemOccurrenceList" Codebehind="EventItemOccurrenceList.ascx.cs" %>
                        ...
                        <div class="grid grid-panel">
                            ...
                            <Rock:Grid ID="gCalendarItemOccurrenceList" runat="server" DisplayType="Full" AllowSorting="true" OnRowSelected="gCalendarItemOccurrenceList_RowSelected" RowItemText="Event Occurrence">
                                <Columns>
                                    ...
                                    <global::asp:HyperLinkField HeaderText="Registration" DataTextField="RegistrationInstance" DataNavigateUrlFields="RegistrationInstanceId" />
                                    <global::asp:HyperLinkField HeaderText="Group" DataTextField="Group" DataNavigateUrlFields="GroupID" />
                                    ...
                                    <Rock:LinkButtonField HeaderText="Copy" CssClass="btn btn-default btn-sm fa fa-clone" OnClick="gCalendarItemOccurrenceList_Copy" HeaderStyle-HorizontalAlign="Center" />
