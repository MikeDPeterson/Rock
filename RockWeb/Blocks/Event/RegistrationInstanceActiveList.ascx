<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Blocks.Event.RegistrationInstanceActiveList" Codebehind="RegistrationInstanceActiveList.ascx.cs" %>
