<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Blocks.Crm.PersonDetail.EditGroup" Codebehind="EditGroup.ascx.cs" %>
                ...
                <div class="tab-content">
                    ...
                    <div id="divNewPerson" runat="server" class="tab-pane active">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="well">
                                    <Rock:DatePicker ID="dpNewPersonBirthDate" runat="server" Label="Birthdate" ValidationGroup="AddPerson" AllowFutureDateSelection="False"/>
