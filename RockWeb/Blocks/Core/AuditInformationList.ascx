<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Blocks.Core.AuditInformationList" Codebehind="AuditInformationList.ascx.cs" %>
                ...
                <div class="grid grid-panel">
                    ...
                    <Rock:Grid ID="gAuditInformationList" runat="server" AllowSorting="true" OnRowSelected="gAuditInformationList_Select">
                        <Columns>
                            ...
                            <global::asp:HyperLinkField DataTextField="PersonName" DataNavigateUrlFields="PersonId" SortExpression="PersonName" DataNavigateUrlFormatString="~/Person/{0}" HeaderText="Who" />
                        </Columns>
                    </Rock:Grid>
                </div>
            </div>
