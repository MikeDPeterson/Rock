<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Blocks.Core.SignatureDocumentList" Codebehind="SignatureDocumentList.ascx.cs" %>
                    ...
                    <div class="grid grid-panel">
                        <Rock:Grid ID="gSignatureDocuments" runat="server" AllowPaging="true" OnRowSelected="gSignatureDocuments_Edit"  RowItemText="Document">
                            <Columns>
                                ...
                                <global:asp:HyperLinkField HeaderText="Document" DataNavigateUrlFields="FileId" DataNavigateUrlFormatString="~/GetFile.ashx?id={0}" DataTextField="FileText" Target="_blank" ItemStyle-HorizontalAlign="Center"  />
