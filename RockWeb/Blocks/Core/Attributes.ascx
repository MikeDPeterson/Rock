<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Blocks.Core.Attributes" Codebehind="Attributes.ascx.cs" %>
                        ...
                        <Rock:Grid ID="rGrid" runat="server" AllowSorting="true" RowItemText="setting" TooltipField="Description" OnRowSelected="rGrid_RowSelected">
                            <Columns>
                                ...
                                <Rock:RockTemplateField ItemStyle-Wrap="false">
                                    ...
                                    <ItemTemplate>
                                        <asp:Literal ID="lEntityQualifier" runat="server" />
                                    </ItemTemplate>
                                ...
                                <Rock:RockTemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:Literal ID="lDefaultValue" runat="server" />
                                    </ItemTemplate>
                                </Rock:RockTemplateField>
                                <Rock:RockTemplateField>
