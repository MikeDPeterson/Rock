<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Blocks.Core.SignatureDocumentTemplateDetail" Codebehind="SignatureDocumentTemplateDetail.ascx.cs" %>
