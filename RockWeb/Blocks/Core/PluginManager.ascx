<%@ Control Language="C#" AutoEventWireup="true" Inherits="RockWeb.Blocks.Core.PluginManager" Codebehind="PluginManager.ascx.cs" %>
    ...
    <asp:Panel id="pnlPackageList" runat="server" DefaultButton="ibSearch">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    <asp:TextBox runat="server" ID="txtSearch" CssClass="form-control pull-right" placeholder="SEARCH"></asp:TextBox>
